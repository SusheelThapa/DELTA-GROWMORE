...
from .views import UserRegistrationView, UserLoginView, UserProfileView, PostView, KhaltiPaymentView, CommentCreateView, LikeCreateView, PredictionView
...
urlpatterns = [
    ...
    path('api/predict/', PredictionView.as_view()),
]