...
/**
 * FinanceHero component showcases key financial and market-related features
 * of the GrowMore platform, using visual icons and brief descriptions.
 *
 * @returns {TSX.Element} The rendered FinanceHero component.
 */
const FinanceHero = () => {
  return (
    <>
      <div className="finance-hero px-[5rem] w-full flex felx-row items-center justify-center">
        {/* Left section with GrowMore features */}
        ...
        <div className="image">
          <img
            src="https://kids.earth.org/wp-content/uploads/2022/04/Untitled-1024-%C3%97-768px-17-900x675.jpg"
            alt=""
            className="h-[10rem]"
          />
        </div>

        {/* Right section with Market and GrowHub features */}
