...
/**
 * A component for displaying a pricing plan card.
 *
 * This component shows details of a pricing plan including the plan name, description, price, and a list of features.
 * Users can toggle the visibility of the features list.
 *
    ...
    <div className="h-[35rem] shadow-md rounded-md w-[22rem] bg-white overflow-hidden flex flex-col my-auto">
      ...
      <div className="h-[12%] w-full bg-black text-white flex items-center justify-between px-2">
        ...
        <label className="relative inline-flex items-center cursor-pointer ">
          ...
          <div
            className={`w-10 h-5 ${
              viewBenefits ? "bg-gray-100" : "bg-gray-600"
