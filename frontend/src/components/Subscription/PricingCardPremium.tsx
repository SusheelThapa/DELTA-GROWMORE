...
const PricingCardPremium = () => {
    ...
    return (
        <div className="h-[35rem] shadow-md rounded-md w-[22rem] bg-gradient-to-r overflow-hidden flex flex-col my-auto"
            style={{
                background:
            ...
            <div className="h-[12%] w-full bg-white text-black flex items-center justify-between px-2"
                ...
                <label className="relative inline-flex items-center cursor-pointer ">
                    ...
                    />
                    <div
                        className={`w-10 h-5 ${viewBenefits ? "bg-black" : "bg-gray-600"
